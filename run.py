...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_mean_centering', type=int, default=1, help='use series mapping')
    parser.add_argument('--use_series_mapping', type=int, default=1, help='use layer norm')
    parser.add_argument('--use_layernorm', type=int, default=1, help='use series mapping')
    # weight_decay
